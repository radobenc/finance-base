...
public class SlovakHolidayCalendar extends HolidayCalendar {
     ...
     * 
     * @param year
     *            The year for which to calculate Slovak Constitution Day.
     * @return a date representing Slovak Constitution Day.
     */
    public static final FinDate slovakConstitutionDay(int year) {
     ...
     * 
     * @param year
     *            The year for which to calculate Slovak National Upspring Day.
     * @return a date representing Slovak National Upspring Day.
     */
    public static final FinDate slovakNationalUpspringDay(int year) {
        FinDate.checkYear(year);
